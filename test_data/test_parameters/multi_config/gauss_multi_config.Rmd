...
PATH = '/home/lactose/Dropbox/Uni/Laborpraktikum/LP-Machine-Learning/test_data/test_parameters/multi_config'
```
...
fig.savefig(PATH + '/fit_nq_cutoff.png')
```
...
fig.savefig(PATH + '/pred_nq_cutoff.png')
```
...
fig.savefig(PATH + '/fit_nc_cutoff.png')
```
